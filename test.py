# -*- coding: utf-8 -*-
"""
Created on Sat May 11 15:33:23 2019
...
def readImagesAndFindChessboards(imageDirectory):
    cacheFile = "C:/Users/harshak/Documents/GitHub/left/chessboards.npz"
    '''try:
    ...
    print("Reading images at ")
    imagePaths = glob.glob("C:/Users/harshak/Documents/GitHub/left/U3TL000*.jpg")
...
(leftFilenames, leftObjectPoints, leftImagePoints, leftSize
        ) = readImagesAndFindChessboards('C:/Users/harshak/Documents/GitHub/left')
(rightFilenames, rightObjectPoints, rightImagePoints, rightSize
        ) = readImagesAndFindChessboards('C:/Users/harshak/Documents/right')
...
np.savez_compressed('C:/Users/harshak/Documents/GitHub/det.npz', imageSize=imageSize,
